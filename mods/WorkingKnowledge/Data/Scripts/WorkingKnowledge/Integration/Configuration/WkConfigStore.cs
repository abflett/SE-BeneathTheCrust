    ...
    internal sealed class WkConfigStore
    {
        ...
        private static WkConfigSettingDefinition[] CreateSettings()
        {
            return new WkConfigSettingDefinition[]
            {
                ...
                Number("dataFragmentLootScale", "Data Fragment Loot Scale", "Research", "0.0 to 100.0", "Multiplier for data fragment loot frequency in patched container definitions. Existing containers are not automatically retroactive; admins can refill empty random cargo with /wk admin resetloot confirm.", delegate(WkConfig c) { return c.DataFragmentLootScale; }, delegate(WkConfig c, double v) { c.DataFragmentLootScale = v; }, "fragmentlootscale", "datafragmentloot"),
