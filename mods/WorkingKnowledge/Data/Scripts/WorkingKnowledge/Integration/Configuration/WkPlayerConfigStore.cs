    ...
    internal sealed class WkPlayerConfigStore
    {
        ...
        private static WkPlayerConfigSettingDefinition[] CreateSettings()
        {
            return new WkPlayerConfigSettingDefinition[]
            {
                ...
                Bool("progressToastEnabled", "Progress Toast", "true/false", "Shows your HUD progress notifications, completion toasts, and botch toasts when world settings allow them.", delegate(WkPlayerConfigRecord c) { return c.ProgressToastEnabled; }, delegate(WkPlayerConfigRecord c, bool v) { c.ProgressToastEnabled = v; }, "toastenabled", "toastnotifications"),
