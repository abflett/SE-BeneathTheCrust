...
- Adds optional `0-9.81 m/s²` Gravity Assist. Spawned payload grids accelerate along the source station grid's Down direction while a player is within 250 metres, allowing long tutorial sessions without continuously simulating unattended payloads.
