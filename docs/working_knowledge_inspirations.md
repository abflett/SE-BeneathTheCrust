...
This page records external Space Engineers mod ideas that helped shape **Working Knowledge**.

These are acknowledgements of design inspiration only. Working Knowledge does not require these mods, bundle them, or include their code, models, textures, icons, or other assets.
