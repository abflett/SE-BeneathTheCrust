...
| [Advanced Welding](https://steamcommunity.com/sharedfiles/filedetails/?id=510790477) | Adds weld pads, handheld grinder detach mode, and precision grinding. | Supports controlled dismantling, repair work, and block recovery as a campaign mechanic. | High synergy with Working Knowledge. Weld pads fall back to Fundamental Schematics through Working Knowledge's uncatalogued public block compatibility path, or can be explicitly mapped through `modBlockSchematicMappings`; still test detach/reattach research and Proficiency attribution carefully. |
