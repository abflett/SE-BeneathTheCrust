...
- `generate-working-knowledge-balance.ps1` derives Working Knowledge schematic work-reward balance from vanilla blueprint/component/block data, writes generated audit reports under `docs/generated/`, and updates `SchematicWorkRewardTable.cs` when run with `-UpdateSource`.
